...
// ================================================
	...
	function TinyMCE_imanager_getControlHTML(control_name) {
		switch (control_name) {
			case 'imanager':
				return '<img id="{$editor_id}_imanager" src="{$pluginurl}/images/imanager.gif" title="Upload Image" width="20" height="20" class="mceButtonNormal" onmouseover="tinyMCE.switchClass(this,\'mceButtonOver\');" onmouseout="tinyMCE.restoreClass(this);" onmousedown="tinyMCE.restoreAndSwitchClass(this,\'mceButtonDown\');" onclick="(iManager_click(\'{$editor_id}\'));">';
			}	
		return '';
	}
	//-------------------------------------------------------------------------
